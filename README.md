...
## 3. What is the different between the VARCHAR and CHAR data type?
...
Aggregate Function (সমষ্টিগত ফাংশন) এমন ফাংশন যেগুলো একাধিক রেকর্ডের উপর কাজ করে এবং একটি একক ফলাফল প্রদান করে।

এগুলো সাধারণত GROUP BY এর সাথে অথবা আলাদাভাবে SELECT এর মধ্যে ব্যবহার করা হয়।
...
এই Query sightings টেবিলে মোট কতটি রেকর্ড (সাইটিং) আছে, তা গণনা করে।

**SUM() – কোন কলামের মোট যোগফল বের করতে**

<pre lang="markdown"> 
SELECT SUM(salary) FROM rangers;

</pre>

এই Query rangers টেবিলের সব রেঞ্জারের মোট বেতন (salary) যোগ করে।
Note: SUM() ব্যবহার করতে হলে অবশ্যই সংশ্লিষ্ট কলামে সংখ্যা (numeric) থাকতে হবে।

**AVG() – গড় (average) মান বের করতে**

<pre lang="markdown"> 
SELECT AVG(salary) FROM rangers;

</pre>

এই Query rangers টেবিলের বেতনের গড় হিসাব করে।
